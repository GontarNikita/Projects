$(function () {
	...
	//anchor url and smooth scrolling
	$('.wrapper_justify nav a[href^="#"]').click(function () {
...
$(document).ready(function () {
	...
	// add action to but form pop_up
	$("input.dop_trigger_but").click(function () {
		$("input.wpcf7-form-control.wpcf7-submit").trigger("click");
		update($("input.wpcf7-form-control.wpcf7-submit"));
	});
	// add new id coments box_pop_up
		var i=0;
	$(".box_holder .box_holder.box_holder_popup").each(function(){
		i++;
	$(this).attr("id","box_holder_view"+i);
	});
	var it=0;
	$(".box_holder_hide").each(function(){
		it++;
	$(this).attr("href","#box_holder_view"+it);
	});
	// add id foto comonet
		var is=0;
	$(".box_review_holder .box_review_popup ").each(function(){
		is++;
	$(this).attr("id","review_popup"+is);
	});
	var ii=0;
	$(".box_review_show").each(function(){
		ii++;
	$(this).attr("href","#review_popup"+ii);
	});
	// add event to but form video
	$("input.trigger_vid_but").click(function () {
		$("input.wpcf7-form-control.wpcf7-submit").trigger("click");
		update($("input.wpcf7-form-control.wpcf7-submit"));
	});
...
$(function () {
	$(".price  input").click(function () {
		...
		$(' input.wpcf7-form-control.wpcf7-text.cost_input').val(sum);
	});
});
// add thumbnail to video
$(document).ready(function(){
   $(".video_reviwes_wrapper .box_review_holder a").find("img").attr("src", function(){
    var attrtube = $(this).parent("a").attr("href").replace('https://www.youtube.com/embed/', '');
    var thumb = "http://img.youtube.com/vi/" + attrtube + "/0.jpg";
    return thumb;
   })
  });
...
$(document).ready(function () {
	...
	$(".slider_recomend_page").owlCarousel({
		autoPlay: 5000,
		navigation: true,
		slideSpeed: 300,
		paginationSpeed: 400,
	...
	$(".slider_feedback_page").owlCarousel({
...
!function (a, b, c, d) { "use strict"; a.fn.slideAndSwipe = function (b) { function g(a, b, g, h) { "start" == b && (e = c.hasClass("ssm-nav-visible") ? 0 : d); var i; "move" == b && "left" == g ? (i = e < 0 ? e - h : -h, j(i, 0)) : "move" == b && "right" == g ? (i = e < 0 ? e + h : h, j(i, 0)) : "cancel" == b && "left" == g && 0 === e ? j(0, f.speed) : "end" == b && "left" == g ? k() : "end" != b && "cancel" != b || "right" != g || console.log("end") } function h() { return /Safari/.test(navigator.userAgent) && /Apple Computer/.test(navigator.vendor) } function i() { return /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor) } function j(b, e) { c.css("transition-duration", (e / 1e3).toFixed(1) + "s"), b >= 0 && (b = 0), b <= d && (b = d), h() || i() ? c.css("-webkit-transform", "translate(" + b + "px,0)") : c.css("transform", "translate(" + b + "px,0)"), "0" == b && (a(".ssm-toggle-nav").addClass("ssm-nav-visible"), a("html").addClass("is-navOpen"), a(".ssm-overlay").fadeIn()) } var c = a(this), d = -c.outerWidth(), e = d, f = a.extend({ triggerOnTouchEnd: !0, swipeStatus: g, allowPageScroll: "vertical", threshold: 100, excludedElements: "label, button, input, select, textarea, .noSwipe", speed: 250 }, b); c.swipe(f); var k = function () { c.removeClass("ssm-nav-visible"), j(d, f.speed), a("html").removeClass("is-navOpen"), a(".ssm-overlay").fadeOut() }, l = function () { c.addClass("ssm-nav-visible"), j(0, f.speed) }; a(".ssm-toggle-nav").click(function (a) { c.hasClass("ssm-nav-visible") ? k() : l(), a.preventDefault() }) } }(window.jQuery || window.$, document, window), "undefined" != typeof module && module.exports && (module.exports = slideAndSwipe);
	...
	$(document).ready(function () {
		var windowWidth = $(window).width();
		if (windowWidth < 992) {
			$('.wrapper_justify nav').slideAndSwipe();
		};
		$('.close_icon').click(function () {
			if ($('.wrapper_justify nav').hasClass('ssm-nav-visible')) {
				$('.wrapper_justify nav').removeClass("ssm-nav-visible");
				$('.wrapper_justify nav').css("transform", "translate(-280px,0)");
			}
