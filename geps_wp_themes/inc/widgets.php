...
// add new popular posts for single page widget
class addSearchForm extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'addSearchForm_search',
			'Блок поиска', // заголовок виджета
			array( 'description' => 'Форма поиска по сайту' ) // описание
			);
	}
 ...
 * регистрация виджета
 */
function true_add_Search_Form() {
	register_widget( 'addSearchForm' );
}
add_action( 'widgets_init', 'true_add_Search_Form' );



// add new popular posts for single page widget
class addTegsblock extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'addTegsblock_meta',
			'Облако меток', // заголовок виджета
			array( 'description' => 'Все метки по сайту хранятся тут' ) // описание
			);
	}
 ...
 * регистрация виджета
 */
function true_add_Tags_block() {
	register_widget( 'addTegsblock' );
}
add_action( 'widgets_init', 'true_add_Tags_block' );
